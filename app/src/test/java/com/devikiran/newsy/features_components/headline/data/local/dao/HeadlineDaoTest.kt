package com.devikiran.newsy.features_components.headline.data.local.dao
...
import com.devikiran.newsy.utils.getTestData
...
class HeadlineDaoTest {
    ...
    fun `removeFavouriteArticle deletes favourite article from db`() = runTest {
        ...
        //THEN
        val actual = headlineDao.getHeadlineArticle(1).asLiveData().value
        val actual2 = headlineDao.getHeadlineArticle(2).asLiveData().value
