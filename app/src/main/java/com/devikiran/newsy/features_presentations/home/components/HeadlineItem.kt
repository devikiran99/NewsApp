package com.devikiran.newsy.features_presentations.home.components
...
import com.devikiran.newsy.features_presentations.core.components.itemPadding
...
private fun HeadlineCard(
    ...
    val imgRequest = ImageRequest.Builder(LocalContext.current)
        ...
        .crossfade(true)
        .build()
    val favouriteIcon = if (article.favourite) Icons.Default.Build
